...
<head>
    ...
    <title>Beranda</title>
    <link rel="stylesheet" href="{{ asset('css/administrator/lecturer.scss') }}">
        ...
        <div class="administrator-dashboard-wrapper">
            ...
            <div class="administrator-dashboard-content">
                <div class="dashboard-name-wrapper">
                    <p class="dashboard-name">registrasi dosen</p>
                </div>
                <form class="form" action="/administrator/dashboard/registrating/student" method="post">
                    ...
                    <div class="input-textbox">
                        <input name="degree" class="input-value" type="text" placeholder="Masukkan gelar...">
                    </div>
